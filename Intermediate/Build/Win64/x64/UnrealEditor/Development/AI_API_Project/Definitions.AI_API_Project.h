...
#define UE_PROJECT_NAME AI_API_Project
#define UE_TARGET_NAME AI_API_ProjectEditor
#define UE_MODULE_NAME "AI_API_Project"
...
#define AI_API_PROJECT_API DLLEXPORT
